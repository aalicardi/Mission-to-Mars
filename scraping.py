...
def scrape_all():
    ...
    data = {
        ...
        # new dictionary for to hold hemisphere image URL string & title DELIVERABLE
...
#  function to scrape hemisphere data from mission_to_mars_challenge file

def hemisphere_data(brower):
